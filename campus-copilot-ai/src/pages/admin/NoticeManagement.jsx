...
export default function NoticeManagement() {
  ...
  const handleChange =
    (event) => {
      ...
      /*
        If the admin changes title/content after
        generating a summary, do not silently delete
        the summary.

        The admin can review it and use "Regenerate".
      */
  ...
  const handleGenerateSummary =
    async () => {
      ...
      if (!title) {
        setError(
          "Enter the notice title before generating a summary."
        );
      ...
      if (!content) {
        setError(
          "Write the notice content before generating a summary."
        );
      ...
      try {
        ...
        if (
          ...
          throw new Error(
            "CampusCopilot returned an empty summary."
          );
        }


        /*
          Store the summary as human-readable
          multiline text.
          ...
          This makes it:
          - easy for admin to review/edit
          - easy to store in Oracle CLOB
          - easy for student page to render as bullets
        */
        ...
        setFormData(
          (previous) => ({
            ...
            /*
              Optionally use the AI urgency only when
              the admin has left the generic defaults.

              We do NOT override a deliberately chosen
              admin category/tag.
            */
        ...
        setSuccess(
          "CampusCopilot Intelligence summary generated. Review it before publishing."
        );

      } catch (err) {
        console.error(
          "Generate notice summary error:",
          err
        );
        ...
        setError(
          err.message ||
            "Unable to generate the notice summary."
        );
  ...
  const handleClearSummary =
    () => {
      ...
      setSuccess(
        "Summary cleared. You can publish the notice without an AI summary or generate a new one."
      );
    };
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                    ...
                    <div>
                      ...
                      <label className="font-label-caps text-outline text-xs uppercase">
                        CampusCopilot Intelligence Summary
                      </label>


                      <p className="text-xs text-outline mt-1">
                        Generate a concise student-friendly summary, review it, and edit it before publishing.
                      </p>
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <button
                        ...
                        className="px-3.5 py-2 rounded-xl bg-tertiary-container text-on-tertiary-container text-xs font-bold flex items-center gap-1.5 hover:opacity-90 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                      ...
                      {formData.aiSummary && (
                        <button
                          ...
                          className="px-3.5 py-2 rounded-xl border border-outline-variant text-on-surface-variant text-xs font-bold flex items-center gap-1.5 hover:bg-surface-container-low transition-all disabled:opacity-50"
                        >
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      placeholder="Click Generate Summary to create a CampusCopilot summary, or write one manually."
                      className="w-full min-h-[120px] rounded-xl border border-outline-variant bg-surface-container-low p-3 text-sm text-on-surface focus:outline-none focus:border-primary resize-y"
                    />


                    {summarizing && (
                      <div className="absolute inset-0 rounded-xl bg-surface/80 backdrop-blur-[1px] flex items-center justify-center">
                  ...
                  <div className="flex items-start gap-1.5 text-xs text-outline">
                    ...
                    <span>
                      The summary is optional. If AI generation fails, you can still publish the original notice normally.
                    </span>
